				...
				<div className='h-full px-14 pb-10 flex items-center mt-28'>
					<div>
						<h1 className='text-5xl font-bold text-newDark'>
							Aviso de <span className='text-primary'>Cookies</span>
						</h1>
						<div className='mt-8 font-medium text-gray-500 text-sm space-y-5 text-justify'>
							<h3 className='text-newDark text-lg'>
							...
							<p>
								...
								un perfil específico para mostrar avisos publicitarios en función del
								mismo.
							</p>

							<h3 className='text-newDark text-lg'>Desactivar las cookies.</h3>
							<p>
							...
							<h3 className='text-newDark text-lg'>Cookies de terceros.</h3>
							...
							<p>
								Además, utilizamos las cookies de Supabase para el inicio de sesión
								de usuarios. Supabase es un servicio de autenticación que permite a
								los usuarios iniciar sesión con su correo electrónico y contraseña, o
								con proveedores externos como Google o Facebook. Las cookies de
								Supabase se usan para guardar la sesión del usuario y acceder a los
								datos almacenados en Supabase.
							</p>
							<p>
								Si continúa navegando está dando su consentimiento para la aceptación
								de las mencionadas cookies y la aceptación de nuestra política de
								cookies.
							</p>
